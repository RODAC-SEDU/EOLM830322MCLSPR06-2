...
$(document).ready( function() {
    ...
    $(".video-url").blur(function(e) {
        if ( $(".video-url").val().length != 0 ){
            if ($("#video_type_video").val() == 'youtube'){
                ...
                var urlVideo = 'https://www.googleapis.com/youtube/v3/videos?id=' + videoId + '&key=AIzaSyBXOu9IDxbfJFiKcrdzKt2HBAN2SMZrIq0&fields=items(snippet(title))&part=snippet';
                ...
                /* else if ($("#video_type_video").val() == 'twitter'){
                console.log("Twitter BLUR...");
                $('.twitter-wrapper').show();
                $('.youtube-wrapper').hide();
                $('.facebook-wrapper').hide();


                $('.twitter-wrapper').html("<div class='row text-center' style='margin-left: 0px;'><div id='twttr-video' data-height='350'>" + "</div></div>");
                ...
                window.twttr.ready(function(_twttr) {
                    twttr.widgets.createVideo(
                        ...
                        function (twttr) {
                            ...
                            twttr.contentDocument.querySelector(".EmbeddedTweet").style.maxWidth = "500px";
                            twttr.contentDocument.querySelector(".EmbeddedTweet").style.maxHeight = "350px";
                            twttr.contentDocument.querySelector(".EmbeddedTweet").style.minHeight = "350px";
                            twttr.contentDocument.querySelector(".NaturalImage-image").style.maxHeight = "350px";
                            twttr.contentDocument.querySelector(".NaturalImage-image").style.minHeight = "350px";

                            $("#video_default_image").val(twttr.contentDocument.querySelector(".NaturalImage-image").getAttribute("src"));
                        }
                    )
                  }
                );
  ...
  $(".video-url").each(function(index, el) {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/videos?id=' + videoId + '&key=AIzaSyBXOu9IDxbfJFiKcrdzKt2HBAN2SMZrIq0&fields=items(snippet(title))&part=snippet',function(response,status,xhr) {
      if(typeof response.items[0] === "undefined") {
          ...
          if($("#type_video").val()=='facebook'){
            ...
            /*if ($("#type_video").val()=='twitter') {
              ...
              $('.twitter-wrapper').show();
              $('.twitter-wrapper').html("<div class='row text-center' style='margin-left: 10px;'><div id='twttr-video'>" + "</div>" +
                  "<div class='col-xs-12'><blockquote style='text-align: left !important;'><h4>" + videoTitle + "</h4></blockquote></div>" +
                  "</div>");
